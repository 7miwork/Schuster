...
ressourcen_dict = {"gold": 100, "energie": 50, "holz": 30, "stein": 20, "bevoelkerung": 10, "nahrung": 50, "forschung": 0, "kohle": 0, "eisen": 0, "roboter": 0}
...
def ereignisse_verarbeiten():
    ...
    for ereignis in pygame.event.get():
        ...
        if ereignis.type == pygame.KEYDOWN:
            ...
            if ereignis.key == pygame.K_g:
                gebaeude_auswahl = 10
                print("Gebäude-Auswahl: Fusionsreaktor (Taste G)")
            if ereignis.key == pygame.K_t and not handel.handelsmenue_ist_offen():
                gebaeude_auswahl = 11
                print("Gebäude-Auswahl: Roboterfabrik (Taste T)")
        ...
        if ereignis.type == pygame.MOUSEBUTTONDOWN:
            ...
            if forschung.forschung_menu_ist_offen():
                ...
                continue
            if handel.handelsmenue_ist_offen() or menu.menu_ist_offen():
                continue
            if ereignis.button == 1:  # 1 = linke Maustaste
                ...
                if (gebaeude.kann_platzieren(liste_gebaeude, gebaeude_auswahl,
                                               kachel_x, kachel_y,
                                               KARTE_BREITE, KARTE_HOEHE) and
                        ressourcen.kann_bauen(ressourcen_dict, liste_gebaeude,
                    ...
                    # kann_bauen() oder die Kachelbelegung hat False zurückgegeben.
...
def spiel_starten():
    ...
    # Forschungs- und Handelsmodule initialisieren
    ...
    while laeuft:
        ...
        menu.menu_zeichnen(gebaeude.GEBAEUDE_TYPEN,
                ...
                # Forschungs- und Handelsmenü liegen als oberste Overlays über der Karte.
...
def hilfe_zeichnen():
    ...
    zeilen = [
        "1-9, 0       — Gebäude auswählen; G = Fusionsreaktor; T = Roboterfabrik",
        ...
        "B            — Springe zur Basis",
        "Leertaste    — Pause / Start; 1 / 2 = Geschwindigkeit",
    ]
