...
| `7`              | Gebäude-Typ: Wohnhaus (violett) — NEU! |
...
Das Spiel hat jetzt **5 Rohstoffe**, die miteinander verbunden sind:
...
**Zusammenhang:** Farmen → Gold → Reaktoren + Holzfäller + Steinmetze + Marktplatz → Energie + Holz + Stein + Gold → Wohnhäuser → Bevölkerung → Kreislauf schließt sich!
