...
KOMBINIERT aus Stunde 1 und Stunde 2
=============================================================================
...
NEU in dieser Version (wie Final Earth 2):
    - Verschiedene Bodentypen (Erde, Gras, Stein, Sand)
    - Zufällig generierte Planeten-Oberfläche
    - Sterne im Hintergrund
    - Größere Karte zum Erkunden
    - Karten-Generation wie in Final Earth 2
...
#
# Final Earth 2 Features in dieser Version:
#   ✓ Unterschiedliche Bodentypen (Erde, Gras, Gestein, Sand)
#   ✓ Zufällig generierte Planeten-Oberfläche
#   ✓ Große Karte zum Erkunden (60 x 40 Kacheln)
#   ✓ Sterne im Weltraum-Hintergrund
#   ✓ Kamera-Scroll mit Pfeiltasten
#   ✓ Legende der Bodentypen im HUD
#
...
#   ✗ karte_zeichnen() in der Spielschleife vergessen → nur schwarzer Bildschirm!
#   ✗ global kamera_x, kamera_y vergessen → UnboundLocalError
#   ✗ hintergrund NACH karte zeichnen → Karte wird übermalt!
#   ✗ karten_daten[zeile][spalte] verwechseln → zeile zuerst, dann spalte!
#
...
#   → Erste Koloniegebäude bauen: Basis, Reaktor, Farm
