...
def _hat_marktplatz(liste_gebaeude):
    return any(g["typ"] == 5 for g in liste_gebaeude)
...
def handel_tick(ressourcen_dict, liste_gebaeude):
    ...
    if (forschung.ist_technologie_erforscht("handel_mit_kolonien") and
            _hat_marktplatz(liste_gebaeude) and _angebot is None and _tick % 20 == 0):
...
def handelsmenue_zeichnen(ressourcen_dict):
    ...
    _fenster.blit(klein.render("Kurs: 2 Einheiten gegen 1 Einheit", True, (160, 220, 220)), (30, 65))
    zeilen = [
